...
export default function StockSearch({ onStockSelect }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const baseURL = "https://twelve-data1.p.rapidapi.com/stocks";
      const options = {
        method: "GET",
        headers: {
          "X-RapidAPI-Key":
  ...
  const handleAddClick = () => {
    if (selectedStock) {
      const selectedStockObject = stockList.data.find(
        (item) => item.symbol === selectedStock
      );
      if (selectedStockObject) {
        const { symbol, name } = selectedStockObject;
        onStockSelect(symbol, name);
      }
    }
  };

  const filteredStockList = stockList.data.filter((item) =>
    item.name.toLowerCase().includes(filterText.toLowerCase())
  );

  return (
    <form className="d-flex" role="search">
      <div className="dropdown stockDropDown">
        <button
      ...
      <button className="btn sbtn" onClick={handleAddClick}>
        ADD
      </button>
    </form>
  );
...
const tempdata = [
  ...
  {
    symbol: "CNAQU",
    name: "Chardan NexTech Acquisition Corp.",
    currency: "USD",
    exchange: "NASDAQ",
    mic_code: "XNCM",
    country: "United States",
  ...
  {
    symbol: "ENSB",
    name: "Ensemble Health Partners, Inc.",
    currency: "USD",
    exchange: "NASDAQ",
    mic_code: "XNGS",
    country: "United States",
  ...
  {
    symbol: "FLXE",
    name: "FlexEnergy Green Solutions, Inc.",
    currency: "USD",
    exchange: "NASDAQ",
    mic_code: "XNCM",
    country: "United States",
  ...
  {
    symbol: "GLEE",
    name: "Gladstone Acquisition Corporation",
    currency: "USD",
    exchange: "NASDAQ",
    mic_code: "XNCM",
    country: "United States",
  ...
  {
    symbol: "KVSD",
    name: "Khosla Ventures Acquisition Co. IV",
    currency: "USD",
    exchange: "NASDAQ",
    mic_code: "XNCM",
    country: "United States",
